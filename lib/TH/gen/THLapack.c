...
extern void dgesv_(int* n, int* nrhs, double* a, int* lda, int* ipiv, double* b,
                   int* ldb, int* info);
extern void sgesv_(int* n, int* nrhs, float* a, int* lda, int* ipiv, float* b,
                   int* ldb, int* info);
...
extern void dsyev_(char* jobz, char* uplo, int* n, double* a, int* lda,
                   double* w, double* work, int* lwork, int* info);
extern void ssyev_(char* jobz, char* uplo, int* n, float* a, int* lda, float* w,
                   float* work, int* lwork, int* info);
extern void dgeev_(char* jobvl, char* jobvr, int* n, double* a, int* lda,
                   double* wr, double* wi, double* vl, int* ldvl, double* vr,
                   int* ldvr, double* work, int* lwork, int* info);
extern void sgeev_(char* jobvl, char* jobvr, int* n, float* a, int* lda,
                   float* wr, float* wi, float* vl, int* ldvl, float* vr,
                   int* ldvr, float* work, int* lwork, int* info);
...
extern void dgetrs_(char* trans, int* n, int* nrhs, double* a, int* lda,
                    int* ipiv, double* b, int* ldb, int* info);
extern void sgetrs_(char* trans, int* n, int* nrhs, float* a, int* lda,
                    int* ipiv, float* b, int* ldb, int* info);
extern void dgetri_(int* n, double* a, int* lda, int* ipiv, double* work,
                    int* lwork, int* info);
extern void sgetri_(int* n, float* a, int* lda, int* ipiv, float* work,
                    int* lwork, int* info);
...
extern void dpotrs_(char* uplo, int* n, int* nrhs, double* a, int* lda,
                    double* b, int* ldb, int* info);
extern void spotrs_(char* uplo, int* n, int* nrhs, float* a, int* lda, float* b,
                    int* ldb, int* info);
extern void sgeqrf_(int* m, int* n, float* a, int* lda, float* tau, float* work,
                    int* lwork, int* info);
extern void dgeqrf_(int* m, int* n, double* a, int* lda, double* tau,
                    double* work, int* lwork, int* info);
extern void sorgqr_(int* m, int* n, int* k, float* a, int* lda, float* tau,
                    float* work, int* lwork, int* info);
extern void dorgqr_(int* m, int* n, int* k, double* a, int* lda, double* tau,
                    double* work, int* lwork, int* info);
extern void sormqr_(char* side, char* trans, int* m, int* n, int* k, float* a,
                    int* lda, float* tau, float* c, int* ldc, float* work,
                    int* lwork, int* info);
extern void dormqr_(char* side, char* trans, int* m, int* n, int* k, double* a,
                    int* lda, double* tau, double* c, int* ldc, double* work,
                    int* lwork, int* info);
extern void spstrf_(char* uplo, int* n, float* a, int* lda, int* piv, int* rank,
                    float* tol, float* work, int* info);
extern void dpstrf_(char* uplo, int* n, double* a, int* lda, int* piv,
                    int* rank, double* tol, double* work, int* info);

void THFloatLapack_gesv(int n, int nrhs, float* a, int lda, int* ipiv, float* b,
                        int ldb, int* info) {
  _THError("generic/THLapack.c", 50,
...
void THFloatLapack_trtrs(char uplo, char trans, char diag, int n, int nrhs,
                         float* a, int lda, float* b, int ldb, int* info) {
  _THError("generic/THLapack.c", 65,
...
void THFloatLapack_gels(char trans, int m, int n, int nrhs, float* a, int lda,
                        float* b, int ldb, float* work, int lwork, int* info) {
  _THError("generic/THLapack.c", 81,
           "gels : Lapack library not found in compile time\n");
}

void THFloatLapack_syev(char jobz, char uplo, int n, float* a, int lda,
                        float* w, float* work, int lwork, int* info) {
  _THError("generic/THLapack.c", 96,
...
void THFloatLapack_geev(char jobvl, char jobvr, int n, float* a, int lda,
                        float* wr, float* wi, float* vl, int ldvl, float* vr,
                        int ldvr, float* work, int lwork, int* info) {
  _THError("generic/THLapack.c", 111,
...
void THFloatLapack_gesvd(char jobu, char jobvt, int m, int n, float* a, int lda,
                         float* s, float* u, int ldu, float* vt, int ldvt,
                         float* work, int lwork, int* info) {
  _THError("generic/THLapack.c", 126,
           "gesvd : Lapack library not found in compile time\n");
}

void THFloatLapack_getrf(int m, int n, float* a, int lda, int* ipiv,
                         int* info) {
  _THError("generic/THLapack.c", 140,
           "getrf : Lapack library not found in compile time\n");
}

void THFloatLapack_getrs(char trans, int n, int nrhs, float* a, int lda,
                         int* ipiv, float* b, int ldb, int* info) {
  _THError("generic/THLapack.c", 153,
           "getrs : Lapack library not found in compile time\n");
}

void THFloatLapack_getri(int n, float* a, int lda, int* ipiv, float* work,
                         int lwork, int* info) {
  _THError("generic/THLapack.c", 167,
           "getri : Lapack library not found in compile time\n");
}

void THFloatLapack_potrf(char uplo, int n, float* a, int lda, int* info) {
  _THError("generic/THLapack.c", 181,
           "potrf : Lapack library not found in compile time\n");
}

void THFloatLapack_potrs(char uplo, int n, int nrhs, float* a, int lda,
                         float* b, int ldb, int* info) {
  _THError("generic/THLapack.c", 195,
           "potrs: Lapack library not found in compile time\n");
}

void THFloatLapack_potri(char uplo, int n, float* a, int lda, int* info) {
  _THError("generic/THLapack.c", 209,
           "potri: Lapack library not found in compile time\n");
}

void THFloatLapack_pstrf(char uplo, int n, float* a, int lda, int* piv,
                         int* rank, float tol, float* work, int* info) {
  _THError("generic/THLapack.c", 223,
           "pstrf: Lapack library not found at compile time\n");
}

void THFloatLapack_geqrf(int m, int n, float* a, int lda, float* tau,
                         float* work, int lwork, int* info) {
  _THError("generic/THLapack.c", 237,
           "geqrf: Lapack library not found in compile time\n");
}

void THFloatLapack_orgqr(int m, int n, int k, float* a, int lda, float* tau,
                         float* work, int lwork, int* info) {
  _THError("generic/THLapack.c", 251,
           "orgqr: Lapack library not found in compile time\n");
}

void THFloatLapack_ormqr(char side, char trans, int m, int n, int k, float* a,
                         int lda, float* tau, float* c, int ldc, float* work,
                         int lwork, int* info) {
  _THError("generic/THLapack.c", 265,
           "ormqr: Lapack library not found in compile time\n");
}
