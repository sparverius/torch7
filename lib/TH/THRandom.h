...
/* A THGenerator contains all the state required for a single random number
 * stream */
...
TH_API void THRandom_manualSeed(THGenerator* _generator,
                                unsigned long the_seed_);
...
*/
TH_API double THRandom_normal(THGenerator* _generator, double mean,
                              double stdv);
...
*/
TH_API double THRandom_cauchy(THGenerator* _generator, double median,
                              double sigma);
...
*/
TH_API double THRandom_logNormal(THGenerator* _generator, double mean,
                                 double stdv);
