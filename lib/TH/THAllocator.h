...
TH_API THMapAllocatorContext* THMapAllocatorContext_new(const char* filename,
                                                        int flags);
TH_API THMapAllocatorContext* THMapAllocatorContext_newWithFd(
...
TH_API void THRefcountedMapAllocator_incref(THMapAllocatorContext* ctx,
                                            void* data);
TH_API int THRefcountedMapAllocator_decref(THMapAllocatorContext* ctx,
                                           void* data);
